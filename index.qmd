...
Die vom Projektleiter Manuel Schneider zur Verfügung gestellten Rohdaten umfassen die in Tabelle X dargestellten Variablen.
...
+-----------+-------------------------------------------------------------------------------------------------------+--------------------------------------------+
| Day       | Tag der Messung                                                                                       | 0-365 (Tagesindez)                         |
+-----------+-------------------------------------------------------------------------------------------------------+--------------------------------------------+
